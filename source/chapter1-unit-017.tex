...
isomorfisme. Funktor $Q$ dalam Definisi \ref{def:cat-localization} secara
	otomatis mempunyai sifat ini---bagian penuh dan setianya diberikan oleh
...
Kini tinggal dikaji keberadaan dan konstruksi lokalisasi. Untuk
$\mathcal{C}$ dan $S$ yang umum,
...
\begin{bukti}
	...
	di atas cukup diperiksa melalui sifat yang bersesuaian dari $\varphi$.
\end{bukti}
...
Misalkan $X \in \Obj(\mathcal{C})$. Sesuai dengan konvensi di atas, bagi
...
\begin{bukti}
	...
	\end{tikzcd}$.
	Dengan demikian, semua syarat bagi kategori terfilter terpenuhi.
\end{bukti}	
...
\begin{bukti}
	...
	di atas tidak melibatkan ukuran himpunan dan dapat dirumuskan dengan tepat
...
\begin{bukti}
	Pertama, biarkan $(V; t, b)$ tetap dan variasikan $(U; s, a)$ di dalam kelas
	ekuivalensinya. Berdasarkan \eqref{eqn:localization-sim}, cukup dibuktikan,
	...
	Untuk kasus ketika $(U; s, a)$ dibiarkan tetap dan $(V; t, b)$ divariasikan
...
\begin{bukti}
	...
	Untuk (i), cukup diperiksa aksioma komposisi morfisme dalam
...
\begin{catatan}\label{rem:localization-size}
	...
	kategori besar: andaikan $S_{/X}^{\opp}$ (atau $S_{X/}$) mempunyai
...
\begin{teorema}\label{prop:localization-additivity}
	...
	\begin{enumerate}[(i)]
		...
		$\mathcal{C}[S^{-1}]^r$) mempunyai struktur kategori-$\cate{Ab}$
...
\begin{contoh}[Lokalisasi sentral]\label{eg:central-localization}
	...
	dengan komposisi morfisme didefinisikan sebagaimana biasa. Pemeriksaan yang
...
\begin{catatan}\label{rem:reflexive-localization}
	...
	$Q:\mathcal{C}\to\mathcal{C}[S^{-1}]$ mempunyai adjoin kanan yang penuh dan
