...
% Label bab/lampiran untuk edisi Bahasa Indonesia. Huruf Latin kapital
% menandai lampiran, sedangkan nomor lain menandai bab.
\providecommand{\AJchapterttl}[1]{\IfSubStr{ABCDEFGHIJKLMNOPQRSTUVWXYZ}{#1}{Lampiran #1}{Bab #1}}
...
% Nomor bagian untuk edisi Bahasa Indonesia
...
\titlecontents{part}
	...
	{\contentsmargin{0pt}\large{Bagian {\thecontentslabel}}\quad}
	{\Large}
	{}
