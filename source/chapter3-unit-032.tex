...
Definisi~\ref{def:complex} telah memperkenalkan secara awal konsep kompleks
beserta notasi yang lazim digunakan. Tetapkan suatu kategori aditif
$\mathcal{A}$ dan tinjau kompleks tak terbatas pada kategori tersebut, yakni
...
perkalian skalar suku demi suku. Dalam hasil-hasil pada bagian ini, kata
...
\begin{definisi}[Objek bergradasi]\label{def:graded-obj}
	...
	Misalkan $\mathcal{A}$ sebarang kategori. Ingat kembali konstruksi kategori
	produk $\mathcal{A}^{\Z}$:
...
% segment-id: o014.li2.chapter3.complexes-over-additive-categories.g001
	...
	hasil ini sudah dapat diduga, kita tuliskan diagramnya secara eksplisit:
...
\begin{konvensi}\label{con:concentrated-cplx}
	...
	funktor aditif yang setia penuh
