...
kategori yang diperlukan dalam bab-bab berikut sebagai penyegaran bagi
pembaca. Sebagian materi ini telah dibahas dalam \cite{Li1} atau buku ajar
sejenis. Meskipun demikian, materi tersebut disajikan kembali di sini untuk
meninjau konsep-konsep itu dan menyeragamkan notasi. Untuk istilah dasar
...
\begin{itemize}
	...
	disebut kategori aditif. Dalam kategori aditif, kita dapat membahas jumlah
	...
	funktor sebagai suatu \emph{hampiran terbaik} dalam bentuk limit. Dicatat
	...
	konkretnya jauh lebih rumit. Agar hasil penginversan lebih mudah
	dikendalikan, dalam praktik $S$ sering diasumsikan membentuk
	\emph{sistem multiplikatif} sebagaimana didefinisikan dalam
	...
	terbatas pada penerapan tersebut, sehingga bagian ini mempunyai nilai
	tersendiri. Pengertian generator dan kogenerator
...
\sourcecrossref{sec:functor-localization}{1.10}. Materi tersebut juga berguna di
luar topik itu, tetapi pembaca dapat menimbang kebutuhannya sendiri dan
