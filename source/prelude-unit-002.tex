...
untuk memahami masa depan tetap bermanfaat. Demi memudahkan pembahasan,
kita akan membagi perkembangan teori homologi secara agak artifisial
...
H.\ Poincaré menjadi kerangka yang lebih kukuh secara matematis. Secara kasar, gagasan
...
bilangan Betti dan versi torsinya hanyalah invarian numerik yang diperoleh
darinya. Gagasan ini sudah mendekati definisi modern dalam topologi
aljabar: untuk ruang $E$ yang dilengkapi suatu penguraian dan grup
...
$\Hm^n(E; A)$ didefinisikan secara dual.
...
\begin{itemize}
	...
	\item Hasil kali cawan (\emph{cup product}) pada kohomologi, yaitu
	struktur perkalian pada grup kohomologi.
...
Derivasi pada gelanggang sejak awal menarik perhatian para ahli aljabar.
Pada tahun 1942, G.\ Hochschild
...
Berbagai konstruksi ini dapat diperluas dengan menggunakan sembarang
bimodul $(R, R)$ $M$, dan terus memainkan peranan penting dalam matematika
mutakhir.
...
\begin{itemize}
	...
	\item pengembangan sistematis teori umum barisan spektral dan struktur
	perkaliannya.
\end{itemize}
...
teori modul belum memadai bagi aljabar homologis. Di samping kategori
modul-$R$ kiri, yakni $R\dcate{Mod}$, kita ingin mengizinkan suatu
...
\begin{itemize}
	...
	dengan memakai konsep barisan eksak panjang, mencirikan funktor-$\delta$
	universal, dan menunjukkan bahwa funktor turunan merupakan
...
kompleks yang menginduksi isomorfisme pada tingkat kohomologi,
...
$\cate{D}(\mathcal{A})$, kita harus memakai barisan morfisme tertentu
...
(\emph{triangulated category}). Dari sudut pandang
...
terletak pada penguraian ruang, kemudian pendefinisian kompleks rantai atau
kompleks yang sesuai untuk menyarikan invarian topologis. Langkah penguraian
pertama dapat dilakukan dengan berbagai cara; himpunan simplisial yang didefinisikan
...
pertemuan pada tingkat yang lebih tinggi antara topologi---khususnya
