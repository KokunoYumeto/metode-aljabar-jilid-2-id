...
\hypersetup{
  ...
  pdfsubject={Pendahuluan lengkap, Bab 1 lengkap, Bab 2 lengkap, Bab 3 lengkap, dan Bab 4 sampai sifat-sifat dasar kategori bertriangulasi},
...
\addbibresource{references-cumulative-through-unit-051.bib}
...
\begin{titlepage}
  ...
  \vspace{0.6em}
  {\large Pendahuluan Lengkap, Bab 1 Lengkap, Bab 2 Lengkap, Bab 3 Lengkap, dan Bab 4 sampai Sifat-Sifat Dasar Kategori Bertriangulasi\par}
  \vfill
...
serta \texttt{chapter2.tex} baris 9--2132, \texttt{chapter3.tex} baris
9--3425, dan \texttt{chapter4.tex} baris 9--560 (sampai akhir Bagian 4.2
tentang sifat-sifat dasar kategori bertriangulasi), serta menandai
perubahan bahasa dan penyajian beserta koreksi sumber secara eksplisit.
Wen-Wei Li dan penerbit sumber tidak mendukung atau mengesahkan terjemahan
independen ini.
...
{\fontsize{8}{9.3}\selectfont\printindex}
