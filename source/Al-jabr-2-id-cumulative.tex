...
\hypersetup{
  pdflang={id-ID},
  pdfauthor={Wen-Wei Li; terjemahan Bahasa Indonesia oleh Codex atas instruksi Floris},
  pdftitle={Metode dalam Aljabar, Jilid 2 - Pembaca Kumulatif Bahasa Indonesia},
  pdfsubject={Pendahuluan lengkap, Bab 1 lengkap, dan Bab 2 hingga Sekilas tentang Teori Kisi},
...
\addbibresource{references-cumulative.bib}
...
\begin{titlepage}
  ...
  \vspace{0.6em}
  {\large Pendahuluan Lengkap, Bab 1 Lengkap, dan Bab 2 hingga Sekilas tentang Teori Kisi\par}
  \vfill
...
\begin{center}
  \small\url{https://github.com/wenweili/AlJabr-2/commit/9a5803ff77dd3257484cb177f851a73770a59dd3}
\end{center}
...
serta \texttt{chapter2.tex} baris 9--720, dan menandai perubahan bahasa serta
