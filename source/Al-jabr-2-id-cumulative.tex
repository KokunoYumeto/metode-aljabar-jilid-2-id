...
\hypersetup{
  ...
  pdfsubject={Pendahuluan lengkap, Bab 1 lengkap, dan Bab 2 lengkap hingga Kategori Grothendieck serta latihan},
...
\addbibresource{references-cumulative-through-unit-030.bib}
...
\begin{titlepage}
  ...
  \vspace{0.6em}
  {\large Pendahuluan Lengkap, Bab 1 Lengkap, dan Bab 2 Lengkap\par}
  \vfill
...
serta \texttt{chapter2.tex} baris 9--2132, dan menandai perubahan bahasa serta
penyajian secara eksplisit. Wen-Wei Li dan penerbit sumber tidak
...
metadata, backend modular, dan QA diproduksi dengan \textbf{OpenAI Codex
