...
\hypersetup{
  ...
  pdfsubject={Pendahuluan lengkap, Bab 1 lengkap, dan Bab 2 hingga Subkategori Serre dan Grup K0},
...
\addbibresource{references-cumulative-through-unit-029.bib}
...
\begin{titlepage}
  ...
  \vspace{0.6em}
  {\large Pendahuluan Lengkap, Bab 1 Lengkap, dan Bab 2 hingga Subkategori Serre dan Grup K0\par}
  \vfill
...
serta \texttt{chapter2.tex} baris 9--1754, dan menandai perubahan bahasa serta
