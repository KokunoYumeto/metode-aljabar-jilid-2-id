...
% segment-id: o014.li2.chapter3.exercises.ex002
	...
	ambil sembarang pasangan morfisme
...
% segment-id: o014.li2.chapter3.exercises.ex003
	\item (Keeksakan terbelah) Misalkan $\mathcal{A}$ kategori abelian dan
...
% segment-id: o014.li2.chapter3.exercises.ex004
	\item Misalkan $\mathcal{A}$ kategori abelian. Buktikan bahwa $X$ merupakan
...
% segment-id: o014.li2.chapter3.exercises.hn003
	\begin{hint}
		...
		Misalkan $n$. Berdasarkan latihan sebelumnya, uraikan
		$X^n=Y^n\oplus Y^{n+1}$; tinggal dibuktikan bahwa $Y^n$ injektif.
		Untuk sembarang morfisme $f:A\to Y^n$ dan monomorfisme
...
% segment-id: o014.li2.chapter3.exercises.i008
		\item Untuk $m\in M$ dan $r\in R$, ambil sembarang
...
% segment-id: o014.li2.chapter3.exercises.ex016
	\item (Versi kompleks dari barisan eksak Milnor) Misalkan $R$ sembarang
...
% segment-id: o014.li2.chapter3.exercises.ex017
	\item Misalkan $\Bbbk$ medan. Definisikan objek $A$ dan $B$ dalam
...
% segment-id: o014.li2.chapter3.exercises.ex022
	...
	modul-$R$ kiri. Untuk sembarang modul-$R$ kiri $M$, penerapan
	...
	untuk setiap $n\in\Z$, dan definisikan
...
% segment-id: o014.li2.chapter3.exercises.i022
		\item Misalkan $\Bbbk$ medan. Deskripsikan $\HHm_k(M)$ dan
...
% segment-id: o014.li2.chapter3.exercises.ex024
	\item Untuk sembarang gelanggang $R$ dan $n\in\Z_{\geq0}$, buktikan bahwa
