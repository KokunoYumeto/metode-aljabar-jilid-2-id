...
Pernyataan-pernyataan utama dalam bagian ini semuanya dinyatakan relatif
terhadap pilihan semesta Grothendieck, bukan dengan berbicara tentang kategori
``besar'' tanpa kualifikasi.

% segment-id: o014.li2.chapter2.grothendieck-categories.p002
Ingat kembali pengertian limit kecil, kelengkapan, dan generator
...
monomorfisme. Argumen-argumen berikut memperlihatkan dengan baik kegunaan
syarat ini.
...
Tetapkan suatu himpunan terurut parsial terfilter dan kecil $(I,\leq)$.
...
monomorfisme. Jika semua $X_i\hookrightarrow X$ memfaktor melalui suatu
subobjek $Z\subset X$, sifat universal tersebut memfaktorkan $\iota$ sebagai
...
Untuk mengembangkan teori lebih lanjut, kita memerlukan beberapa persiapan
yang berkaitan dengan generator.
...
objek $X$ serta monomorfisme $S_i\hookrightarrow X$ dengan $i=1,2$, hasil kali serat
...
\begin{bukti}
Misalkan $s$ generator kuat dan $X$ sebarang objek. Kita mengklaim bahwa
...
$q\epsilon\neq0\epsilon=0$; morfisme $\epsilon$ ini tidak dapat memfaktor
melalui $S_1=\Ker(q)$.
\end{bukti}

% segment-id: o014.li2.chapter2.grothendieck-categories.c001
\begin{korolari}\label{prop:Grothendieck-cat-wellpowered}
Setiap kategori Grothendieck merupakan kategori well-powered sekaligus
co-well-powered (Definisi~\ref{def:well-powered}).
\end{korolari}
% segment-id: o014.li2.chapter2.grothendieck-categories.pf005
\begin{bukti}
Kategori abelian memiliki semua hasil kali serat hingga, sedangkan setiap
himpunan $\Hom$ kecil menurut asumsi. Jadi sifat well-powered mengikuti dari
...
\begin{bukti}
Kategori $\mathcal{A}$ kolengkap dan co-well-powered. Terapkan
...
dan hasil kali langsung kecil. Bagian latihan akan menunjukkan bahwa morfisme
...
banyak objek injektif. Sesungguhnya, kita akan menunjukkan bahwa bukan hanya
...
kategori well-powered. Untuk data $I\xleftarrow{f}A\hookrightarrow B$ seperti
...
terdapat $g:s\to B$ yang tidak dapat memfaktor melalui $A'\hookrightarrow B$.
...
Sekarang kita akan memperkenalkan suatu variasi dari apa yang disebut
...
regular; uraian berikut memerlukan operasi serta sifat-sifat dasarnya.
...
\begin{definisi}\label{def:I-small}
	...
	terfilter, $I\subset\Mor(\mathcal{C})$ sebarang himpunan bagian, dan $\alpha$
...
% segment-id: o014.li2.chapter2.grothendieck-categories.i006
		...
		$\widetilde{\alpha}$ kardinal kecil regular dengan
...
% segment-id: o014.li2.chapter2.grothendieck-categories.i007
		\item Jika $X$ adalah objek $\alpha$-kecil relatif terhadap
...
kardinal kecil regular. Jika $\alpha>\kappa:=|\mathrm{Sub}_X|$, maka $X$
...
hasil kali serat. Dengan sekali lagi menggunakan keeksakan $\varinjlim$
...
Perhatikan ordinal $\sigma:=\sup S\leq\alpha$. Kita mengklaim bahwa
...
diperoleh $\mathrm{cf}(\alpha)<\alpha$, bertentangan dengan regularitas
$\alpha$. Klaim ini memastikan bahwa $f^{-1}(Y_\beta)$ selalu merupakan
subobjek dari $f^{-1}(Y_\sigma)$ untuk $\beta\in S$. Akibatnya,
$f^{-1}(Y_\sigma)=X$, sehingga $f$ memfaktor melalui $Y_\sigma$.
\end{bukti}
...
% segment-id: o014.li2.chapter2.grothendieck-categories.q007
	...
	Dengan Lema \sourcecrossref{prop:enough-regular-cardinal}{A.2.10}, pilih kardinal kecil regular
	$\alpha$ sedemikian sehingga $\alpha>|\mathrm{Sub}_s|$. Kita tunjukkan
	bahwa $F_\alpha X$ injektif untuk setiap $X$. Diberikan
	$Y\hookrightarrow s$ dan $f:Y\to F_\alpha X$. Definisi kardinal regular
	...
	\ref{prop:alpha-small}, diperoleh bahwa $f$ memfaktor melalui suatu
...
\begin{bukti}
	...
	$s\to T$, yang memfaktor sebagai $s\twoheadrightarrow Q'\hookrightarrow T$.
...
Karakterisasi lebih lanjut bagi kategori Grothendieck diberikan oleh Teorema
...
% segment-id: o014.li2.chapter2.grothendieck-categories.hn001
	\begin{hint}
		Diberikan rantai ganda $(X_n,\alpha_n,\beta_n)_{n=0}^\infty$, penetapan
		$f\mapsto\beta_n f\alpha_n$ menentukan barisan monomorfisme modul
		$\Bbbk$
		$\Hom(X_{n+1},X_{n+1})\hookrightarrow\Hom(X_n,X_n)$. Tunjukkan bahwa
		morfisme ini merupakan isomorfisme tepat ketika $\alpha_n$ dan
...
% segment-id: o014.li2.chapter2.grothendieck-categories.p012
	...
	menambahkan secara formal semua suku jumlah langsung pada $\mathcal{C}$.
...
% segment-id: o014.li2.chapter2.grothendieck-categories.ex005
	\item Untuk suatu gelanggang $R$, verifikasikan bahwa semua modul projektif
	$R$ membentuk kategori Karoubi yang bukan kategori abelian.
...
% segment-id: o014.li2.chapter2.grothendieck-categories.ex006
	...
	$S$ dari unsur-unsur $\Sigma$ beserta epimorfisme $S\twoheadrightarrow X$
...
% segment-id: o014.li2.chapter2.grothendieck-categories.q010
		...
		setiap morfisme $\varphi$ memfaktor melalui $f$. Karena itu setiap
...
% segment-id: o014.li2.chapter2.grothendieck-categories.hn004
	\begin{hint}
		Bentuk monomorfisme $(A+B)\cap C\to A$, lalu tunjukkan bahwa ia memfaktor
...
% segment-id: o014.li2.chapter2.grothendieck-categories.ex008
	\item Buktikan bahwa kategori abelian modul $\Z$ yang dibangun secara hingga
...
% segment-id: o014.li2.chapter2.grothendieck-categories.ex011
	\item Verifikasikan secara rinci relasi adjoin dalam Contoh
...
% segment-id: o014.li2.chapter2.grothendieck-categories.i014
		...
		dengan
		$(\mathcal{L}_cX)(c')=\bigoplus_{\Hom(c,c')}X$. Lengkapi definisi pada
...
% segment-id: o014.li2.chapter2.grothendieck-categories.g012
		...
		\end{tikzcd}\]
		Syarat bagi keluarga generator setara dengan pernyataan bahwa, ketika
...
% segment-id: o014.li2.chapter2.grothendieck-categories.hn007
		\begin{hint}
			...
			Verifikasikan bahwa kategori ini mempunyai sifat universal yang
...
% segment-id: o014.li2.chapter2.grothendieck-categories.i019
		...
		merupakan kategori well-powered (Definisi \ref{def:well-powered}), maka
...
% segment-id: o014.li2.chapter2.grothendieck-categories.hn008
	\begin{hint}
		Gunakan Teorema penyempurnaan Schreier
...
% segment-id: o014.li2.chapter2.grothendieck-categories.hn009
	\begin{hint}
		Ingat dahulu bahwa $\End(X_i)$ gelanggang lokal menyiratkan bahwa $X_i$
...
% segment-id: o014.li2.chapter2.grothendieck-categories.ex019
	...
	$\bigoplus_{i\in I}X_i\to X$ membatasi pada setiap $X_i$ sebagai inklusi
...
% segment-id: o014.li2.chapter2.grothendieck-categories.i022
		\item Lengkapi bukti rigor dari Catatan
...
% segment-id: o014.li2.chapter2.grothendieck-categories.i023
		...
		Verifikasikan asumsi ini untuk $\mathcal{A}=R\dcate{Mod}$.
