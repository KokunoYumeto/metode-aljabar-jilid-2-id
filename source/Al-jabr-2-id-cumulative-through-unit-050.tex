...
\hypersetup{
  ...
  pdfsubject={Pendahuluan lengkap, Bab 1 lengkap, Bab 2 lengkap, Bab 3 lengkap, dan Bab 4 sampai akibat isomorfisme untuk segitiga dengan objek nol},
...
\addbibresource{references-cumulative-through-unit-050.bib}
...
\begin{titlepage}
  ...
  \vspace{0.6em}
  {\large Pendahuluan Lengkap, Bab 1 Lengkap, Bab 2 Lengkap, Bab 3 Lengkap, dan Bab 4 sampai Akibat Segitiga dengan Objek Nol\par}
  \vfill
...
9--3425, dan \texttt{chapter4.tex} baris 9--258 (sampai akibat isomorfisme
untuk segitiga dengan objek nol), serta menandai
