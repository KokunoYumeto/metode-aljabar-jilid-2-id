...
\hypersetup{
  ...
  pdfsubject={Pendahuluan lengkap, Bab 1 lengkap, Bab 2 lengkap, dan Bab 3 sampai Bagian 3.8},
...
\addbibresource{references-cumulative-through-unit-039.bib}
...
\begin{titlepage}
  ...
  \vspace{0.6em}
  {\large Pendahuluan Lengkap, Bab 1 Lengkap, Bab 2 Lengkap, dan Bab 3 sampai Bagian 3.8\par}
  \vfill
...
9--1585, serta menandai perubahan bahasa dan penyajian secara eksplisit. Wen-Wei Li dan penerbit sumber tidak
