...
% segment-id: o014.li2.chapter4.triangulated-basics.g001
	...
	\end{tikzcd}\]
	Jika setiap baris merupakan segitiga terbedakan dan sembarang dua di antara
...
\begin{bukti}
	Setelah merotasi secara tepat dengan (TR3), tanpa mengurangi keumuman kita
...
% segment-id: o014.li2.chapter4.triangulated-basics.q001
	...
	(atau versi yang bersesuaian dengan $\Hom(\cdot, S)$) semuanya eksak. Jika
	...
	diperluas ke keadaan ketika kedua baris merupakan segitiga khusus (atau
	segitiga kokhusus).
\end{catatan}
...
\begin{bukti}
	Diberikan segitiga-segitiga terbedakan
...
diverifikasi dengan merotasinya ke keadaan berikut.
...
\begin{bukti}
	Berdasarkan dualitas, cukup ditinjau keadaan ketika $F$ merupakan funktor
	bertriangulasi. Korolari~\ref{prop:automatic-additivity} menunjukkan bahwa
	$G$ aditif. Nyatakan kedua funktor pergeseran pada $\mathcal{D}$ dan
...
% segment-id: o014.li2.chapter4.triangulated-basics.g009
	...
	$\mathcal{D}$, ambil citranya di bawah $F$, lalu terapkan (TR3) untuk
...
% segment-id: o014.li2.chapter4.triangulated-basics.g013
	...
	\end{tikzcd}\]
	dan karena itu juga eksak. Karena $B$ sebarang,
...
% segment-id: o014.li2.chapter4.triangulated-basics.i002
		...
		memberikan ekuivalensi di antara kategori-kategori prabertriangulasi.
	\end{compactenum}
\end{korolari}
...
\begin{bukti}
	...
	$\mathcal{D}$, kedua segitiga tersebut terlihat isomorfik. Karena
	...
	Korolari~\ref{prop:Cone-uniqueness} yang sudah dikenal menunjukkan bahwa
...
% segment-id: o014.li2.chapter4.triangulated-basics.q005
	...
	Bagi setiap keluarga subkategori penuh $(\mathcal{C}_i)_{i \in I}$, dengan
...
\begin{bukti}
	Caranya ialah memverifikasi syarat dalam
	...
	$\mathcal{D}$ yang dua sukunya berasal dari
...
\S~\sourcecrossref{sec:triangulated-localization}{4.3}; hasil ini bergantung pada aksioma
oktahedral (TR5).
...
% segment-id: o014.li2.chapter4.triangulated-basics.q010
	...
	tinjau morfisme $(o, p, q, -To)$ dalam diagram. Masalahnya tereduksi menjadi
	membuktikan bahwa diagram berikut komutatif:
...
\begin{catatan}
	...
	Perhatikan kemiripan keluarga antara Teorema Keterwakilan Brown dan berbagai
