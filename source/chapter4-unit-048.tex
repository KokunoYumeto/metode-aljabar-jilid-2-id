...
representasi. Informasi yang direkam oleh kategori turunan
$\cate{D}(\mathcal{A})$ dari kategori abelian $\mathcal{A}$ berada di antara
kompleks dan kohomologinya. Informasi itu tepat diungkapkan dengan bahasa
...
\begin{enumerate}
	...
	$\cate{K}(\mathcal{A})$. Kategori terakhir dilengkapi funktor pergeseran
...
peningkatan funktor turunan kiri klasik $\mathrm{L}_nF$ dituliskan sebagai
berikut.%
...
Keberadaan funktor turunan dan struktur terperinci kategori turunan, seperti
dalam teori klasik, bergantung pada resolusi kompleks. Resolusi merupakan
perancah yang diperlukan untuk bekerja secara konkret dengan kategori turunan.
...
$\cate{D}(\mathcal{A})$, kemudian memperkenalkan peningkatan dari $\lim^n$
...
Terakhir, perlu dikemukakan beberapa kekurangan kategori turunan
$\cate{D}(\mathcal{A})$.
...
\begin{petunjukbacaan}
	...
	para spesialis, tetapi pembaca hendaknya menimbang sendiri kebutuhannya.
