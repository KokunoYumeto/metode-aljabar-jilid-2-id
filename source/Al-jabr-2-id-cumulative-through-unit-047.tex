...
\hypersetup{
  ...
  pdfsubject={Pendahuluan lengkap, Bab 1 lengkap, Bab 2 lengkap, dan Bab 3 lengkap},
...
\addbibresource{references-cumulative-through-unit-047.bib}
...
\begin{titlepage}
  ...
  \vspace{0.6em}
  {\large Pendahuluan Lengkap, Bab 1 Lengkap, Bab 2 Lengkap, dan Bab 3 Lengkap\par}
  \vfill
...
9--3425, serta menandai perubahan bahasa dan penyajian beserta koreksi sumber
secara eksplisit. Wen-Wei Li dan penerbit sumber tidak mendukung atau
mengesahkan terjemahan independen ini.
