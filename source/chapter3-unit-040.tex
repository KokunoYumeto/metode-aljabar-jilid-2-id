...
Pada awal bagian ini, tetapkan suatu kategori aditif $\mathcal{A}$.
...
% segment-id: o014.li2.chapter3.truncation-functors.q001
	...
	$n \notin [s, t] \implies X^n = 0$, dan tetapkan
...
Untuk setiap $\star \in \{+, -, \bdd\}$, gagasan homotopi morfisme
...
abelian. Kita akan
mengkaji cara memenggal bagian kompleks $X$ yang berderajat $< n$ (atau
...
\begin{bukti}
	Misalkan $h \in \Hom^{-1}(X, Y)$. Untuk kasus $\tau^{\leq n}$, tetapkan
...
% segment-id: o014.li2.chapter3.truncation-functors.g002
	...
	Untuk kasus $\tau^{\geq n}$, sebagai gantinya tetapkan
