...
parsial yang disebut kisi. Pembahasan ini akan membantu memperjelas struktur
kategori abelian.
...
ada dalam kategori $\mathcal{P}$; dalam hal ini supremum (atau infimum)
...
produk kosong), dan objek awal (yakni koproduk kosong) di dalam kategori; hal
ini dapat diperiksa langsung.

% segment-id: o014.li2.chapter2.glimpse-of-lattice-theory.p006
Sebagai ilustrasi operasi $\wedge$ dan $\vee$, buktikan fakta berikut. Jika
...
\end{equation}
Berdasarkan definisi supremum, mula-mula cukup dibuktikan
$a^\flat \leq (a^\flat \vee b) \wedge a$ dan
$(a \wedge b) \leq (a^\flat \vee b) \wedge a$. Berdasarkan definisi infimum,
selanjutnya cukup dibuktikan masing-masing ketaksamaan
...
\begin{itemize}
	...
	$x \vee y=\mathrm{lcm}(x,y)$ dan $x \wedge y=\mathrm{gcd}(x,y)$. Pembaca
	dapat memeriksa bahwa kisi ini modular, mempunyai batas bawah $1$, tetapi
	tidak mempunyai batas atas.

	% segment-id: o014.li2.chapter2.glimpse-of-lattice-theory.i004
	\item Ambil gelanggang $R$ dan modul-$R$ kiri $M$. Himpunan submodulnya
...
Lema Zassenhaus dalam aljabar elementer (lihat \cite[Lema 4.6.4]{Li1},
khususnya versi teori modulnya) beserta konsekuensi-konsekuensinya dapat
...
\begin{bukti}
	...
	diagram; yang perlu diperiksa ialah relasi-relasi dalam
	...
	karena itu, cukup memeriksa bagian kirinya. Relasi urutan parsial di antara
...
\begin{bukti}
	...
	$\left(x_{i,j}\right)_{i,j}$, dengan urutan tersebut, memperhalus
	...
	inversnya. Terbuktilah pernyataan tersebut.
\end{bukti}
...
Pertanyaan penting berikutnya ialah menentukan interval mana dalam suatu
himpunan terurut parsial yang mempunyai deret komposisi. Seperti dalam teori modul yang
...
\begin{lema}\label{prop:lattice-composition-series}
	...
	\begin{enumerate}[(i)]
		...
		\item Jika $[a,b]$ merupakan kisi modular dan mempunyai deret
...
\begin{definisi}\label{def:lattice-length}
	...
	$r \in \Z_{\geq 0}$ disebut \emph{panjang} $(P,\leq)$.
\end{definisi}
