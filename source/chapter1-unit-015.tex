...
Bagian ini berangkat dari persoalan memperluas funktor. Tinjau kategori
...
% segment-id: o014.li2.chapter1.kan-extensions.g006
	...
	ini ekstensi Kan tersebut tepat merupakan limit yang bersangkutan.
...
Dalam praktik, sejumlah situasi menuntut penguatan lebih lanjut terhadap
konsep ekstensi Kan\footnote{Salah satu penguatan yang lazim disebut ekstensi Kan
...
% segment-id: o014.li2.chapter1.kan-extensions.i009
		\item Misalkan ekstensi Kan kanan $(\Ran_K F, \varepsilon)$ ada. Funktor
		$M: \mathcal{E} \to \mathcal{F}$ dikatakan
...
% segment-id: o014.li2.chapter1.kan-extensions.i010
		\item Misalkan ekstensi Kan kiri $(\Lan_K F, \eta)$ ada. Funktor
		$M: \mathcal{E} \to \mathcal{F}$ dikatakan
...
Langkah berikutnya adalah menjelaskan hubungan antara adjungsi dan ekstensi Kan
...
komposisi vertikal dan horizontal tanpa penjelasan lebih lanjut; langkah ini
...
% segment-id: o014.li2.chapter1.kan-extensions.g025
		...
		\end{tikzcd},
	\end{gathered}\end{equation*}
	dengan label anak panah yang tidak menimbulkan ambiguitas dihilangkan.
