...
\begin{bukti}
	...
	pernyataan tersebut tereduksi pada keeksakan
...
Hasil berikut menunjukkan arah sebaliknya: dari sebarang barisan eksak pendek
...
% segment-id: o014.li2.chapter3.mapping-cone-and-long-exact-sequences.g002
	...
	$X[1]\simeq\Cone(X\to0)\to\Cone(g)$) tidak lain ialah $\Phi$ (atau
...
\begin{bukti}
	...
	Untuk kategori abelian umum $\mathcal{A}$, pertama-tama tetapkan
...
\begin{bukti}
	...
	Proposisi~\ref{prop:connecting-eta-delta}, persoalan tereduksi pada
	pembuktian $(\eta')^n+\eta^n=0$. Namun, persamaan terakhir merupakan akibat
...
\begin{korolari}\label{prop:cone-connecting}
	Diberikan sebarang morfisme $f:X\to Y$ dalam $\cate{C}(\mathcal{A})$,
	morfisme penghubung
...
% segment-id: o014.li2.chapter3.mapping-cone-and-long-exact-sequences.g015
	...
	Lema~\ref{prop:cone-alpha} tidak lain ialah $(0,\beta(f))$ di sini:
