...
\begin{bukti}
	...
	sulit. Antikomutativitas diagram cukup dibuktikan dengan mengamati bahwa diagram
% segment-id: o014.li2.chapter3.double-complexes.g006
	...
	Sekarang tinjau pernyataan tentang diagram komutatif. Misalkan
...
\begin{konvensi}\label{con:bifunctor}
	...
	$F(\cdot,X_2):\mathcal{A}_1\to\mathcal{B}$. Dengan demikian, kita dapat membahas
...
antara kategori-kategori aditif, dan andaikan $F$ aditif dalam setiap
...
\begin{bukti}
	...
	$f_1=d^{-1}g:X_1\to Y_1$ dalam $\cate{C}(\mathcal{A}_1)$ dan sembarang
...
% segment-id: o014.li2.chapter3.double-complexes.g009
	...
	\end{tikzcd}\]
	dan Proposisi~\ref{prop:double-cplx-swap}, cukup dibuktikan bahwa terdapat
	isomorfisme kanonik
	\[
...
% segment-id: o014.li2.chapter3.double-complexes.q021
	...
	(dengan substitusi $k=-q$), yang tepat merupakan $\Hom^n(X,Y)$.
...
% segment-id: o014.li2.chapter3.double-complexes.g010
	...
	$\Hom^{\bullet,\bullet}(X,Y)$ secara alami menjadi funktor bernilai dalam
