...
Bagian ini bertujuan mengkaji kohomologi bikompleks $X$ dalam arah horizontal
...
Sekarang perhatikan fakta sederhana tetapi penting berikut. Untuk objek $X$ dari
...
\begin{bukti}
	...
	misalnya Proposisi~\ref{prop:abelian-cat-cplx}, cukup dibuktikan bahwa,
	untuk setiap $n \in \Z$, barisan
...
\begin{bukti}
	...
	\]
	yang terkonsentrasi pada derajat $h-1$ dan $h$. Oleh karena itu, jika didefinisikan
	\[
		Z := F_{\mathrm{I}}^{-1}
		\Cone\left( \identity_{Y_{\mathrm{I}}[-h]} \right),
	\]
...
\begin{bukti}
	Syarat tersebut ekuivalen dengan syarat bahwa morfisme
	...
	ialah mereduksi pembuktian ke kasus ketika
...
% segment-id: o014.li2.chapter3.double-complex-cohomology.g005
	...
	$\alpha_q$ juga demikian. Karena untuk $q \ll 0$, $\alpha_q$ tepat
	merupakan $0 \rightiso 0$, secara rekursif diperoleh bahwa $\alpha_q$ dan
...
\begin{bukti}
	...
	kedua kasus dapat diturunkan satu dari yang lain dengan menggunakan
	Proposisi~\ref{prop:double-cplx-swap}.
\end{bukti}
