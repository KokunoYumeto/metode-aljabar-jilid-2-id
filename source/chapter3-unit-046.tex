...
merujuk \cite[Bab 14]{KS06} atau \cite{BN93}.
...
\begin{teorema}\label{prop:K-resolution-homotopy}
	Misalkan $\alpha:X\to Y$ suatu kuasi-isomorfisme di
	$\cate{C}(\mathcal{A})$.
...
dalam Lema \ref{prop:K-injective-truncated}. Dengan demikian,
...
meskipun lebih rumit daripada yang diperlukan, dapat diberikan menggunakan sifat universal kernel
...
\begin{bukti}
	Lema \ref{prop:K-injective-equiv} menunjukkan bahwa cukup dibuktikan bahwa
	$A\to\Cone(\Delta_{\tau A})[-1]$ merupakan kuasi-isomorfisme untuk
	setiap $A\in\Obj(\cate{C}(\mathcal{A}))$. Misalkan $n\in\Z$. Karena
...
% segment-id: o014.li2.chapter3.k-injectives.q006
	...
	\]
	Jika penalaran dengan elemen dapat digunakan dalam $\mathcal{A}$, maka setelah
...
% segment-id: o014.li2.chapter3.k-injectives.g010
	...
	diagonal. Argumen ini mudah diterjemahkan ke kategori $\mathcal{A}$
...
Sesungguhnya, setiap kompleks pada kategori Grothendieck mempunyai resolusi
