...
secara garis besar dapat dikelompokkan ke dalam dua arah. Ambil $\varinjlim$ sebagai
...
sebagaimana biasa. Menurut definisi, $\varinjlim \alpha$ beserta keluarga
...
Funktor $F$ secara alami menginduksi funktor
...
$\varinjlim$ (atau $\varprojlim$) berarti bahwa kokonus (atau
...
\begin{contoh}\label{eg:Grp-Set-create}
	...
	\begin{enumerate}
		...
		sehingga setiap $p_i$ merupakan homomorfisme grup, serta menunjukkan bahwa
...
\begin{bukti}
	Cukup tinjau kasus $\varinjlim$. Untuk (i), misalkan
	...
	$\mathcal{C}^J$. Langsung dapat diverifikasi bahwa
	...
	\end{tikzcd}\]
	Cukup ditunjukkan bahwa bagian persegi komutatif untuk setiap
