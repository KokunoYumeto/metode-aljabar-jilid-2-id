...
\begin{contoh}\label{eg:comma-vs-cone}
	...
	\ref{def:comma-category}, $(\alpha/\Delta)$ tidak lain adalah kategori
...
Mudah diperiksa bahwa jika $I \to J$ dan $J \to K$ keduanya kofinal, maka
...
Hasil berikut menunjukkan bahwa limit dapat dihitung setelah diagram dibatasi
di sepanjang funktor kofinal. Ingat bahwa $H$ menginduksi
$H^{\opp}: J^{\opp} \to I^{\opp}$.
...
\begin{bukti}
	...
	$j \in \Obj(J)$ dan $i \to H(j)$; syarat tersebut lalu tereduksi menjadi
...
\begin{bukti}
	...
	Untuk sifat terfilter $J$, ambil sembarang $i, j \in \Obj(J)$. Karena $I$
	...
	untuk kategori terfilter. Syarat kedua dapat ditangani dengan gagasan yang
	sama.
\end{bukti}
...
Apa kegunaan konstruksi ini? Tinjau sembarang funktor
...
limit-limit tersebut ada. Hasil berikut menjelaskan suatu cara untuk
...
\begin{bukti}
	...
	$\varprojlim$ rangkap dari himpunan. Persoalannya tereduksi menjadi
	memeriksa, untuk keluarga himpunan $(X_i)_{i \in \Obj(I)}$ beserta keluarga
	morfisme kompatibel
...
terhadap peubah $I$ dan $J$ masing-masing dapat diambil $\varinjlim$ dan
...
\begin{bukti}
	...
	berhingga, kita dapat memilih objek penerima bersama $i\in\Obj(I)$ untuk
	...
	Karena $\Mor(J)$ berhingga dan $I$ terfilter, kita dapat memilih penerus
	bersama $i\to i_1$, mengganti semua wakil dengan citranya di indeks $i_1$,
	lalu menamai
	...
	dapat memilih satu penerus bersama, mengganti semua komponen dengan citranya
	di sana, lalu menamainya kembali sebagai $i$, sehingga
