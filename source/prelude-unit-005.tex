...
Tujuannya ialah memastikan terlebih dahulu simbol dan konvensi yang
...
Pertama adalah \emph{Bagian Dalam}, yang meletakkan landasan.
...
\begin{description}
	...
	turunan antara kategori-kategori turunan. Dalam sudut pandang klasik,
	$\Ext$ dan $\Tor$ kemudian ditingkatkan menjadi $\RHom$ dan $\otimesL$.
	...
	beserta penerapannya dalam konteks aljabar. Pasangan eksak tidak mutlak
	diperlukan untuk barisan spektral kompleks terfilter.
\end{description}

% segment-id: o014.li2.prelude.structure-overview.p003
Berikutnya adalah \emph{Bagian Luar}, yang memuat penerapan atau, dengan kata
...
\begin{description}
	...
	berlandaskan bahasa monad. Bagian-bagian terakhir membahas teorema
...
Menurut rencana semula, \emph{Bagian Luar} seharusnya mencakup pengetahuan dasar
teori representasi, yang diperkirakan dapat memainkan peranan alami dalam
keseluruhan sistem. Pada tahap akhir, rencana tersebut dibatalkan karena
...
Terakhir, laman pribadi penulis menyediakan informasi tambahan terbaru,
termasuk daftar ralat, baik untuk buku ini maupun karya lainnya. Pembaca
dipersilakan mengikutinya. Jika menemukan kesalahan dalam buku ini,
