...
Konsep kompleks telah diperkenalkan secara awal dalam
\S~\ref{sec:cohomology}. Untuk kompleks $X=(X^n,d^n)_n$ pada kategori
...
kompleks yang semua kohomologinya nol merupakan barisan eksak, yang juga
...
menyatakan sebarang gelanggang komutatif.
...
homotopi tidak memengaruhi tindakan morfisme pada tingkat kohomologi.
...
secara mendalam dalam \S~\sourcecrossref{sec:resolutions}{3.11}. Resolusi juga
funktorial dan unik hingga homotopi: untuk versi injektif, misalkan bagian
...
dalam versi kompleks tidak terelakkan menjadi panjang, meskipun gagasan
...
\begin{petunjukbacaan}
	...
	tidak mempunyai motivasi topologis, disarankan terlebih dahulu melewati
