...
Tetapkan kembali suatu kategori aditif $\mathcal{A}$ beserta kategori kompleks
...
\begin{contoh}
	...
	Maka $\Cone(f)$ tidak lain ialah kompleks $[X\xrightarrow{f}Y]$ (pada
...
\begin{definisi}\label{def:cone-triangle}
	...
	Tinjau suatu morfisme $f:X\to Y$ dalam $\cate{C}(\mathcal{A})$. Untuknya
	dapat dikonstruksi morfisme-morfisme kanonik berikut dalam
	$\cate{C}(\mathcal{A})$:
...
\begin{proposisi}\label{prop:homotopy-kernel-cokernel}
	Tetapkan suatu morfisme $f:X\to Y$ dalam $\cate{C}(\mathcal{A})$. Terdapat
...
% segment-id: o014.li2.chapter3.mapping-cone.g002
	...
	\end{tikzcd}\]
	dengan $T$ sebarang objek $\cate{C}(\mathcal{A})$ dan
...
\begin{proposisi}\label{prop:cone-homotopy}
	Tetapkan suatu kategori aditif $\mathcal{A}$.
...
% segment-id: o014.li2.chapter3.mapping-cone.i006
		\item Untuk sebarang morfisme $f:X\to Y$ dalam
...
% segment-id: o014.li2.chapter3.mapping-cone.q014
	...
	Masalahnya tereduksi pada verifikasi pernyataan-pernyataan berikut dalam
	$\cate{C}(\mathcal{A})$:
...
\begin{bukti}
	...
	memang memberikan morfisme kompleks. Setelah hal ini ditetapkan,
...
bahwa, hingga isomorfisme dalam $\cate{K}(\mathcal{A})$, sebarang morfisme
...
\begin{proposisi}\label{prop:cylinder-homotopy}
	...
	Misalkan $X$ suatu objek $\cate{C}(\mathcal{A})$ dan tetapkan
...
% segment-id: o014.li2.chapter3.mapping-cone.i013
		\item Untuk sebarang objek $Y$ dari $\cate{C}(\mathcal{A})$, terdapat
		bijeksi
...
\begin{bukti}
	...
	Lema~\ref{prop:cone-beta} mengimplikasikan bahwa keduanya memberikan
	...
	Untuk (ii), tuliskan sebarang unsur $\tilde{h}$ dari
...
\begin{catatan}\label{rem:cone-chain}
	...
	morfisme kompleks rantai $f:X\to Y$, tetapkan
