...
Langkah pertama ialah merumuskan kembali keberadaan funktor adjoin dalam bentuk
...
\begin{bukti}
	Misalkan $c$ tetap. Menentukan morfisme
...
% segment-id: o014.li2.chapter1.adjoint-functor-theorem.g003
	...
	$c\in\Obj(\mathcal{C})$. Kita akan menunjukkan bahwa $Fc$, bersama dengan
...
% segment-id: o014.li2.chapter1.adjoint-functor-theorem.q002
	...
	\end{align*}
	Bijeksi-bijeksi ini jelas bersifat funktorial dalam $c$ dan $d$. Jadi
...
\begin{proposisi}\label{prop:comma-cat-completeness}
	...
	Misalkan $c\in\Obj(\mathcal{C})$ tetap.
...
\begin{bukti}
	Untuk (i), sifat konservatifnya jelas. Inti argumennya ialah bahwa untuk
	...
	eksplisit, definisikan $f$ sebagai komposit pada baris pertama diagram komutatif
	berikut:
% segment-id: o014.li2.chapter1.adjoint-functor-theorem.g004
	...
	Verifikasi selebihnya rutin dan dihilangkan; lihat contoh-contoh
...
% segment-id: o014.li2.chapter1.adjoint-functor-theorem.q003
	...
	$d'\dtimes{d}d'$ dapat diidentifikasi dengan $d'$ melalui identifikasi yang sama.
...
% segment-id: o014.li2.chapter1.adjoint-functor-theorem.g006
	...
	morfisme $k:e\to\Ker(f,g)$. Dengan demikian, diperoleh
...
\begin{bukti}
	...
	berarti bahwa $(c/G)$ mempunyai keluarga awal lemah
	...
	``hanya jika'' jelas. Untuk arah sebaliknya, menurut Lema
	\ref{prop:jointly-weak-initial-obj} tinggal dibuktikan bahwa $(c/G)$
	lengkap. Namun, inilah isi Proposisi
...
\begin{contoh}\label{eg:generators}
	Kita tinjau beberapa contoh awal generator dan kogenerator.
...
% segment-id: o014.li2.chapter1.adjoint-functor-theorem.i010
		...
		$R\to M$ sama artinya dengan menentukan suatu unsur dari $M$. Dengan
...
\begin{definisi}\label{def:well-powered}
	...
	Suatu kategori $\mathcal{E}$ disebut \emph{berdaya-baik}
	(\emph{well-powered}) atau \emph{koberdaya-baik}
...
Dalam bagian ini, sifat berdaya-baik akan dipadukan dengan kelengkapan. Untuk
setiap unsur $\mathrm{Sub}_e$, pilih sebuah wakil $s\hookrightarrow e$.
...
% segment-id: o014.li2.chapter1.adjoint-functor-theorem.i012
	\item Jika $\mathcal{E}$ lengkap, maka sifat berdaya-baik menyiratkan
...
% segment-id: o014.li2.chapter1.adjoint-functor-theorem.i013
	\item Jika $\mathcal{E}$ kolengkap, maka sifat koberdaya-baik menyiratkan
...
\begin{lema}\label{prop:cogenerator-initial-obj}
	Misalkan $\mathcal{E}$ kategori lengkap yang berdaya-baik. Jika terdapat
...
\begin{bukti}
	...
	unsur $\mathrm{Sub}_e$ (hanya pada langkah ini syarat berdaya-baik
...
% segment-id: o014.li2.chapter1.adjoint-functor-theorem.i015
			\item $\mathcal{D}$ lengkap dan berdaya-baik, serta $G$
...
% segment-id: o014.li2.chapter1.adjoint-functor-theorem.i018
			\item $\mathcal{C}$ kolengkap dan koberdaya-baik, serta $F$
...
\begin{bukti}
	...
	demikian, $(c/G)$ terbukti berdaya-baik.
\end{bukti}

% segment-id: o014.li2.chapter1.adjoint-functor-theorem.co001
\begin{korolari}\label{prop:SAFT-completeness}
	Jika kategori lengkap yang berdaya-baik $\mathcal{D}$ mempunyai keluarga
	kogenerator $\Sigma$, maka $\mathcal{D}$ kolengkap.

	Secara dual, jika kategori kolengkap yang koberdaya-baik $\mathcal{C}$
...
\begin{contoh}
	...
	kecil tetap kecil; jadi $\cate{CHaus}$ berdaya-baik. Teorema
...
Lampiran \S~A.1.
Intinya ialah pengamatan berikut. Jika funktor
...
% segment-id: o014.li2.chapter1.adjoint-functor-theorem.hn009
	\begin{hint}
		Misalkan $x\neq y$ unsur-unsur dari $X$. Terdapat grup $H$ beserta
