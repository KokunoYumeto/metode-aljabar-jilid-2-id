...
Untuk memenuhi fungsinya sebagai buku rujukan, buku ini memerlukan tingkat
sistematika yang memadai. Karena itu, setiap bab terutama disusun menurut
...
belajar. Bagian yang melibatkan lampiran sebaiknya dilewati dahulu atau
...
membungkus gagasan matematika dengan berlapis-lapis penghalang berupa teks.
Pembelajar mandiri harus mengerahkan upaya sungguh-sungguh untuk mengenali
matematika yang sesungguhnya di dalamnya, layaknya menangkap kilat di
...
\begin{itemize}
	...
	\item Berbagai pernyataan dan pembuktian selalu diberi beragam rujuk silang
	secara telaten, sehingga pembaca yang sudah memiliki pengetahuan tertentu
...
menyiapkan pengajaran atau mengikuti seminar untuk segera merangkai butir
pengetahuan yang mereka perlukan, lalu meleburkannya ke dalam bahasa mereka
sendiri.
...
ini di ruang kelas, sehingga hasilnya belum diketahui. Berdasarkan
...
mungkin dapat dipadatkan menjadi satu semester dalam mode ringkas. Jika
buku ini digunakan sebagai buku ajar utama, pengajar harus terlebih dahulu
membagi isinya. Penulis berharap rancangan modular yang telah disebutkan
...
klasik. Sebagiannya disebabkan keadaan praktis, dan sebagian lagi
oleh keterbatasan penulis; penulis hanya dapat memohon kemurahan hati
pembaca.
...
Tujuannya terutama untuk menambahkan sifat-sifat atau hasil pelengkap,
...
membentuk sebuah ``kelas''. Sebagai konsekuensi menyingkirkan kelas sejati
(\emph{proper class}) dari definisi, secara ketat kita harus memperkenalkan
