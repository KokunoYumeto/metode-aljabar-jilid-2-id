...
Misalkan $\mathcal{A}$ suatu kategori aditif. Bagian ini bertujuan
...
% segment-id: o014.li2.chapter3.opposite-category-complexes.g001
	...
	Seluruh verifikasi cukup dilakukan melalui
...
\begin{bukti}
	Misalkan $X,Y$ objek dalam $\cate{C}(\mathcal{A}^{\opp})$. Untuk
...
% segment-id: o014.li2.chapter3.opposite-category-complexes.q007
	...
	memang merupakan isomorfisme dalam $\cate{C}(\mathcal{A})$. Setelah itu,
	verifikasi komutativitas tidak lagi mengandung kesulitan
	yang berarti.
\end{bukti}
