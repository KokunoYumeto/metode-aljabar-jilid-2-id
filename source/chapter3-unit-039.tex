...
\begin{definisi}[Kompleks bar]\label{def:bar-Hochschild}
	...
	Misalkan $R$ suatu aljabar-$\Bbbk$. Untuk setiap
...
% segment-id: o014.li2.chapter3.exercises-hochschild-homology-and-cohomology.q004
	...
	dan $r_0,\ldots,r_{n+1}\in R$, diperoleh
...
\begin{konvensi}\label{con:Re-R-R}
	\index[sym1]{R-e@$R^e$}
	Definisikan $R^e:=R\otimes R^{\opp}$. Untuk setiap bimodul $(R,R)$ $M$,
...
% segment-id: o014.li2.chapter3.exercises-hochschild-homology-and-cohomology.i003
	...
	sebagai $(m|r_1|\cdots|r_n)$. Definisikan
...
Untuk setiap $n\in\Z_{\geq0}$, terdapat isomorfisme
...
% segment-id: o014.li2.chapter3.exercises-hochschild-homology-and-cohomology.q014
	...
	$M=R$, ini tepat merupakan pusat dalam pengertian teori gelanggang.
...
Untuk setiap $n\geq0$, definisikan
...
didefinisikan bernilai $0$. Morfisme $d_q$ dan $d'_q$ didefinisikan dalam
...
Dengan demikian, diperoleh barisan eksak pendek bikompleks
