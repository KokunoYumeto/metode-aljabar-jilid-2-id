...
demikian, kita masih dapat mencari pendekatan optimal bagi masalah ekstensi
...
Gagasan untuk menangani masalah ini ialah memilih subkategori $\mathcal{C}$
secara saksama. Kita melanjutkan konvensi dari
...
\begin{proposisi}\label{prop:subcat-localization}
	...
	kanan). Tetapkan $T := S \cap \Mor(\mathcal{I})$.
...
% segment-id: o014.li2.chapter1.kan-extensions-along-localization.g006
	...
	Pilih sembarang funktor kuasi-invers dari $\iota_Q$ dan nyatakan funktor
	...
	\ref{prop:Kan-limit} (i), keberadaan $\Lan_Q F$ tereduksi pada pembuktian
	bahwa $\varinjlim F \Pi_{/\underline{X}}$ ada untuk setiap
	$\underline{X}$.
	...
	pada kelas isomorfisme $\underline{X}$, sehingga (i) mereduksinya pada
...
% segment-id: o014.li2.chapter1.kan-extensions-along-localization.g007
	...
	$\varinjlim FU$ bukan hanya ada, melainkan juga bernilai konstan $FX$;
...
\begin{bukti}
	...
	diturunkan kepada $MF: \mathcal{C} \to \mathcal{F}$.
