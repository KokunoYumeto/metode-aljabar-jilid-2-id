...
$Kc \to d$ (atau $d \to Kc$). Kedua arah limit ini akan mempunyai sifat
...
Selanjutnya kita meninjau funktor komposit
...
\begin{bukti}
	...
	$(\Lan_K F)(Kc)$, persamaan \eqref{eqn:Kan-limit-aux-2} tepat merupakan
	...
	unik. Untuk $d$ tetap, tinjau sembarang objek $(c, Kc \to d)$ dalam $(K/d)$
	...
	Sekarang tinjau (iii). Misalkan $c \in \Obj(\mathcal{C})$. Karena $K$ penuh
...
\begin{contoh}[Citra invers praberkas (presheaf)]
	...
	topologis. Definisikan $\mathcal{C} := \cate{Open}_Y$ sebagai kategori yang
	...
	definisi, tepat merupakan praberkas pada $Y$, sedangkan
