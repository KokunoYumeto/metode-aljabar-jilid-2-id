...
Pada \S~\ref{sec:Ker-Coker} telah diperkenalkan pengertian
kategori-$\cate{Ab}$ dan kategori aditif. Kategori abelian yang dikaji dalam
bab ini merupakan suatu kelas kategori aditif dengan sifat-sifat khusus.
...
kategori-$\cate{Ab}$. Caranya, untuk funktor
$F, G: I \rightrightarrows \mathcal{A}$, penjumlahan dalam
$\Hom_{\mathcal{A}^I}(F, G)$ didefinisikan secara objek demi objek melalui
...
\begin{bukti}
	...
	serta kernel dan kokernel, dalam $\mathcal{A}^I$ dibangun secara objek demi
	objek. Citra dan kocitra suatu morfisme, dan karena itu juga morfisme kanonik
	$\Coim \to \Image$, dibangun secara objek demi objek. Dengan demikian,
...
\begin{bukti}
	Cukup ditangani kasus diagram tarik balik. Kita nyatakan bahwa
	...
	Pernyataan mengenai $\Ker$ memang mengikuti deskripsi
	...
	\[\begin{tikzcd}
		...
		X' \arrow[r, "g"'] & Y'
	\end{tikzcd}\]
	merupakan diagram dorong keluar. Dengan mengomposisikan kedua kolom
	masing-masing dengan automorfisme $-\identity_X$ dan $-\identity_Y$,
...
Untuk sebarang gelanggang $R$, semua hasil di atas tentu sudah dikenal bagi
kategori modul kiri $R\dcate{Mod}$; hal yang sama berlaku bagi kategori modul
kanan.
