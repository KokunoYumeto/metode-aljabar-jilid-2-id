...
Sebelumnya telah didefinisikan $\Hom$ antara dua kompleks. Bagian ini
menjelaskan cara menjadikannya suatu kompleks, serta cara menjadikan komposisi
morfisme sebagai sejenis perkalian pada kompleks. Misalkan kembali
$\mathcal{A}$ suatu kategori aditif. Jika $\Bbbk$ sembarang
...
% segment-id: o014.li2.chapter3.hom-complex-and-homotopy.q002
	...
	$d_Y$. Berdasarkan definisi ini, definisikan
...
\begin{bukti}
	Pertama-tama, buktikan $d^{n+1}d^n=0$. Karena
...
% segment-id: o014.li2.chapter3.hom-complex-and-homotopy.q008
	...
	$\overline{f}$ serupa: walaupun kasus $\overline{f}$ tidak memuat
...
\begin{bukti}
	...
	unsur $\Hom^0(X,Y[n])$, sehingga cukup ditinjau kasus $n=0$.
...
\begin{bukti}
	...
	Lema~\ref{prop:Hom-cplx-Leibniz} memberikan
...
\end{align*}
	dengan $I$ sembarang himpunan, asalkan $\prod_{i\in I}Y_i$ (atau
$\coprod_iX_i$) ada pada tingkat $\cate{C}(\mathcal{A})$. Karena pengambilan
	...
	pernyataan ini cukup dibuktikan melalui isomorfisme kompleks $\Hom$ yang jelas:
...
% segment-id: o014.li2.chapter3.hom-complex-and-homotopy.q016
	...
	\end{gather*}
	Sesungguhnya, gunakan konvensi dalam Catatan~\ref{rem:cochain-vs-chain} dengan
...
\]
Dengan demikian, diperoleh funktor $\cate{K}F:\cate{K}(\mathcal{A})\to
...
% segment-id: o014.li2.chapter3.hom-complex-and-homotopy.g004
	...
	\end{tikzcd}\]
	secara alami juga membentuk pasangan adjoin.
\end{proposisi}
...
\begin{bukti}
	...
	\Hom_{\mathcal{A}}(A,GB)$ yang bersifat funktorial dalam $A$ dan $B$.
