...
\hypersetup{
  ...
  pdfsubject={Pendahuluan lengkap, Bab 1 lengkap, Bab 2 lengkap, dan ikhtisar Bab 3},
...
\addbibresource{references-cumulative-through-unit-031.bib}
...
\begin{titlepage}
  ...
  \vspace{0.6em}
  {\large Pendahuluan Lengkap, Bab 1 Lengkap, Bab 2 Lengkap, dan Ikhtisar Bab 3\par}
  \vfill
...
9--55, serta menandai perubahan bahasa dan penyajian secara eksplisit. Wen-Wei Li dan penerbit sumber tidak
