...
mencakup Unit 001–029: seluruh Pendahuluan, seluruh Bab 1, dan Bab 2 sampai
bagian “Subkategori Serre dan Grup K0” (`chapter2.tex` upstream baris
9–1754). Pembaca saat ini berjumlah 175 halaman. Produksi
...
- `source/`: penutup kumulatif, 29 unit terjemahan, bibliografi, kelas, gaya,
  konfigurasi font/judul, dan aset lisensi yang diperlukan untuk membangun PDF.
- `backend/`: 29 unit, 1.448 segmen, dan 385 istilah dalam bentuk modular
  (`JSONL`/`CSV`).
- `provenance/`: pembekuan sumber, hak komponen, koreksi, terminologi, baseline
  build, audit terminologi Indonesia, QA Unit 029, serta manifes.
